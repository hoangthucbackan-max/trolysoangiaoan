...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Văn Thực - Trường PTDTBT Tiểu học Đường Âm - ĐT: 0333819299</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Văn Thực - Trường PTDTBT Tiểu học Đường Âm - ĐT: 0333819299</div>", unsafe_allow_html=True)
